...
const Service = ({ service }) => {
    ...
    return (
        <div className="main-angel hover:bg-[#012863]">
            <div className=" bg-[#FFFFFF] md:w-[25rem] w-full md:p-16 mr-10 p-6 hover:bg-[#012863] group time-duration hover:text-white">
